...
const tabIds = ["translator", "practice", "stories", "advanced", "grammar", "vocabulary"];
const state = {
  search: "",
  category: "All",
  limit: 120,
...
const advancedGrid = document.querySelector("#advancedGrid");
...
storyGrid.innerHTML = data.stories.map((story) => {
...
advancedGrid.innerHTML = data.advancedTexts.map((text) => `
